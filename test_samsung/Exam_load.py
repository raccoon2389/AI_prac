...
lstm_s = LSTM(100,activation='tanh',dropout=0.2)(lstm_s)
lstm_h = LSTM(50,activation='tanh',dropout=0.2,return_sequences=True)(input_hite)
lstm_h = LSTM(100,activation='tanh',dropout=0.2)(lstm_h)
...
# loss : 0.0032424750136701647
# acc : 0.003242475213482976
# R2 : 0.944067932723772
# next : [[50261.27]]
