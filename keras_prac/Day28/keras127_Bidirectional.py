from keras.layers import Dense, Embedding, LSTM, Flatten, Conv1D, MaxPool1D, BatchNormalization, Dropout, Bidirectional
...
x_train = pad_sequences(x_train, maxlen=111, padding='post')
