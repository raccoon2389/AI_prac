...
model.add(Conv2D(32*2,kernel_size=3, padding='same',activation='relu',input_shape=(32,32,3)))
model.add(Conv2D(32*2,kernel_size=3, padding='same',activation='relu'))
model.add(MaxPooling2D(pool_size=(2,2),strides=2,padding='same'))
model.add(Dropout(0.2))

model.add(Conv2D(32*4,kernel_size=3, padding='same',activation='relu',input_shape=(32,32,3)))
...
hist = model.fit(x_train,y_train,batch_size=32,epochs=30,validation_split=0.3)
