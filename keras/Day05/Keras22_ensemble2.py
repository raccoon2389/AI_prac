...
y1 = np.array([range(1, 101), range(311, 411)])
y2 = np.array([range(711, 811),range(711, 811)])
...
dense2_1 = Dense(50,activation='relu', name='bitking4')(input2)
dense2_2 = Dense(49,activation='relu', name='bitking5')(input2)
...
model.fit([x1_train, x2_train], [y1_train, y2_train, y3_train], validation_split=0.25 ,epochs=100, batch_size=1, verbose=1) # verbose = 0: 아무것도 안보임 1: 기본값 2: 프로그레스바 삭제 3: epoch만
...
# 4. evaluate,predict
loss, mse,x,y,z,f,k = model.evaluate([x1_test,x2_test], [y1_test, y2_test, y3_test], batch_size=1)
print("loss : ", loss, "\nmse : ", mse,x,y,z)
