...
model.load_weights('./keras_prac/model/test_weights.h5')
...
# model.save('./keras_prac/model/model_test01.h5')
...
'''
# model.save('./keras_prac/model/model_test01.h5')
# model.save_weights('./keras_prac/model/test_weights.h5')
...
plt.show()
'''
# [0.06755406107404269, 0.9797000288963318]
