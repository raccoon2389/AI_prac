...
from keras.layers import Dense,Conv2D,Flatten,MaxPooling2D,Dropout,Input, Activation,BatchNormalization
...
model.add(Conv2D(32*2,kernel_size=3, padding='same'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(Dropout(0.3))
...
model.add(Conv2D(32*4,kernel_size=3, padding='same'))
model.add(BatchNormalization())
model.add(Activation('relu'))
model.add(Dropout(0.3))
model.add(Conv2D(32*4,kernel_size=3, padding='same'))
