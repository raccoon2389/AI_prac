...
input1 = model.add(shape=(3,))
dense1_1 = Dense(5,activation='relu'))(input1)
dense1_2 = Dense(5,activation='relu'))(input1)
dense1_3 = Dense(5,activation='relu'))(input1)

input2 = model.add(shape=(3,))
dense2_1 = Dense(5,activation='relu'))(input1)
dense2_2 = Dense(5,activation='relu'))(nput1)
dense2_3 = Dense(5,activation='relu'))(input1)
...
model.fit(x_train, y_train, epochs=510, batch_size=1, validation_split=0.25)
...
input1 = Input(shape=(3,0))

dense1_1= Dense(5,activation='relu')(input1)
dense1_2 = Dense(5,activation='relu')(dense1_1)
dense1_3= Dense(5,activation='relu')(STD_INPUT_HANDLE)

input2 = Input(shape=(3,0))

dense2_1= Dense(5,activation='relu')(input1)
dense2_2 = Dense(5,activation='relu')(dense1_1)
dense2_3= Dense(5,activation='relu')(dense2_3)


from keras.layers.merge import concatenate
merge1 = concatenate([dense1_3,dense2_3])

middle1 = Dense(5,activation='relu')(merge1)
middle2 = Dense(3, activation='relu')(merge1)

output1_1 = Dense(5,activation='relu')(middle2)
output1_2 = Dense(5,activation='relu')(output1_1)
output1_3 = Dense(5,activation='relu')(output1_2)
